...
GOOGLE_MAPS_API_KEY = "AIzaSyDEMV8xtHOKniRbKpbzkdZwMPkqiX2tsUo"
...
all_waypoints = [
    "Calle 12 #5-32, bogota, colombia",
    "Liftit HQ, bogota, colombia",
    "Calle 140 #21-39, bogota, colombia",
...
def CreateOptimalRouteHtmlFile(optimal_route, distance, display=True):
    ...
    localoutput_file = output_file.replace(
        '.html', '_' + str(distance) + '.html')
            ...
            if (generation % generations_10pct == 0 or generation == generations - 1) and rank == 0:
                ...
                if population_fitness[agent_genome] < current_best_distance or current_best_distance < 0:
                    ...
                    CreateOptimalRouteHtmlFile(
                        agent_genome, current_best_distance, False)
...
if __name__ == '__main__':
    ...
    if os.path.exists(file_path):
        ...
        for (waypoint1, waypoint2) in combinations(all_waypoints, 2):
            try:
                ...
                waypoint_distances[frozenset(
                    [waypoint1, waypoint2])] = distance
                waypoint_durations[frozenset(
                    [waypoint1, waypoint2])] = duration
    ...
    optimal_route = run_genetic_algorithm(
        generations=thisRunGenerations, population_size=thisRunPopulation_size)
    print("BEST ROUTE\n")
    print(optimal_route)
